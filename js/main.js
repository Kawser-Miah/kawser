...
(function () {
  ...
  (function () {
    var COMMANDS = [
      { cmd: '/about', desc: 'Who is Kawser?', answer: 'Kawser Miah — Flutter developer building production-grade Android & iOS apps that are fast, scalable, and built to last. Flutter Developer @ Join Venture AI; pursuing a B.Sc. in CSE at Green University of Bangladesh. 11+ apps built, 2 on the stores.\nClean Architecture with Bloc & Riverpod, real-time WebSocket features, geohash geolocation matching, offline-first data layers — plus Python/FastAPI backends with ML (TensorFlow CNN inference, RAG pipelines). Top 50 finalist of 242 teams at HackTheAI 2025.' },
